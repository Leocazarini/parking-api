...
import { fmtDuration, parseApiDate, formatTicket, blurDateInput, openDatePicker } from '../utils'
      ...
      <div className="hist-filter-wrap">
        <div className="hist-filter-grid">
          ...
          <div className="form-group" style={{ margin: 0 }}>
            ...
            <input className="form-input" type="date" value={dateFrom} onChange={(e) => { setDateFrom(e.target.value); blurDateInput(e.target as HTMLInputElement) }} onFocus={openDatePicker} onClick={openDatePicker} />
          </div>

          <div className="form-group" style={{ margin: 0 }}>
            <label className="form-label">Data final</label>
            <input className="form-input" type="date" value={dateTo} onChange={(e) => { setDateTo(e.target.value); blurDateInput(e.target as HTMLInputElement) }} onFocus={openDatePicker} onClick={openDatePicker} />
          </div>
